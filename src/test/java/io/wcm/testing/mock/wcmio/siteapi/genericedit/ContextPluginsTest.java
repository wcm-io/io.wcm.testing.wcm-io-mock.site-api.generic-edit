...
public class ContextPluginsTest {
  ...
  public AemContext context = new AemContextBuilder()
      .plugin(CACONFIG)
      .plugin(WCMIO_SLING, WCMIO_SITEAPI_GENERICEDIT).build();

  @Test
  public void testServices() {
    assertNotNull(context.getService(GenericEditConfig.class));
    assertNotNull(context.getService(GenericComponentBuilderService.class));
  }
